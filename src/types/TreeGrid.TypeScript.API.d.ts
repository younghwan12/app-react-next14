...
interface TTGrid {
    ...
    CopyImg(row: TRow, col: string, idx: number, refresh?: boolean | number, undo?: boolean | number): boolean | number;
    ...
    DeleteImg(row: TRow, col: string, idx: number, refresh: boolean | number, undo: boolean | number): boolean | number;
    ...
    DragGanttRunByMouse(tag: object, event: Event, run: string, row: TRow, html?: string): boolean | number;
    ...
    ScrollToCell(row: TRow | null, col: string | null, top: number | null, left?: number | null): void;
...
interface TGridsApi {
    ...
    OnChangeImage(grid: TGrid, row: TRow, col: string, val: string, old: string): string | null | undefined | void;
    OnChangeWinScroll(grid: TGrid, clear: boolean | number): boolean | number | null | undefined | void;
    ...
    OnDropFile(grid: TGrid, row: TRow, col: string, files: any): boolean | number | null | undefined | void;
    OnDropFileError(grid: TGrid, row: TRow, col: string, files: any): boolean | number | null | undefined | void;
    OnEditAttrs(
        grid: TGrid,
        row: TRow,
        col: string,
    ...
    OnExportCell(grid: TGrid, row: TRow, col: string, exrow: any, excol: string): null | undefined | void;
    ...
    OnImportCell(grid: TGrid, imrow: any, imcol: string, row: any, col: string): null | undefined | void;
    OnImportCopyCell(grid: TGrid, srcrow: any, srccol: string, row: any, col: string): null | undefined | void;
    ...
    OnLoadSheet(grid: TGrid, name: string, hidden: boolean | number): boolean | number | null | undefined | void;
    ...
    OnMediaUse(grid: TGrid, M: any, use: boolean | number): boolean | number | null | undefined | void;
    OnMenu(
        grid: TGrid,
        row: TRow,
        col: string,
    ...
    OnRowRemove(grid: TGrid, row: TRow, type: number): boolean | number | null | undefined | void;
    ...
    OnSelectedAll(grid: TGrid, select: number, type: number | number): boolean | number | null | undefined | void;
    OnSetChooseCells(
        grid: TGrid,
        range: any,
        selection: number,
    ...
    OnSetLink(grid: TGrid, cells: any, test: boolean | number): boolean | number | null | undefined | void;
    OnSetFile(grid: TGrid, row: TRow, col: string, files: any): boolean | number | null | undefined | void;
